...
def submit_task():
    ...
    # store the tasks
    with open("C:\\Users\\HP\\PycharmProjects\\To_Do App\\tasks.txt", "a") as f:
...
def delete_task():
    ...
    if click_del_btn == 0:
        with open("C:\\Users\\HP\\PycharmProjects\\To_Do App\\tasks.txt", "r") as f:
            items = f.readlines()
        f.close()
    print(items)
...
def final():
    ...
    with open("C:\\Users\\HP\\PycharmProjects\\To_Do App\\tasks.txt", "w") as f:
...
def view():
    ...
    if os.path.exists("C:\\Users\\HP\\PycharmProjects\\To_Do App\\tasks.txt"):
        with open("C:\\Users\\HP\\PycharmProjects\\To_Do App\\tasks.txt", "r") as f:
            tasks = f.readlines()
        f.close()
...
def reset_file():
    os.remove("C:\\Users\\HP\\PycharmProjects\\To_Do App\\tasks.txt")
